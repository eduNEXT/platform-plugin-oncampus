...
"""
platform-plugin-oncampus documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-oncampus',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/platform-plugin-oncampus",
...
#
# html_title = 'platform-plugin-oncampus v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Open edX Django plugin for On Campus initiatives (Unidigital).',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_oncampus'),
                os.path.join(root_path, 'platform_plugin_oncampus/migrations')])
