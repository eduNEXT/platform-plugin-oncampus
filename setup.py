#!/usr/bin/env python
"""
Package metadata for platform_plugin_oncampus.
"""
import os
import re
import sys
...
VERSION = get_version('platform_plugin_oncampus', '__init__.py')
...
setup(
    name='platform-plugin-oncampus',
    version=VERSION,
    description="""Open edX Django plugin for On Campus initiatives (Unidigital).""",
    long_description=README + '\n\n' + CHANGELOG,
    author='eduNEXT',
    author_email='technical@edunext.co',
    url='https://github.com/eduNEXT/platform-plugin-oncampus',
    packages=find_packages(
        include=['platform_plugin_oncampus', 'platform_plugin_oncampus.*'],
        exclude=["*tests"],
    ),
